...
class AccountOperations(object):
    ...
    def list_supported_images(
        ...
        deserialized = models.ImageInformationPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ImageInformationPaged(internal_paging, self._deserialize.dependencies, header_dict)
