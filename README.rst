...
.. code-block:: bash
    ...
    $ az extension add --source https://github.com/Azure/azure-batch-cli-extensions/releases/download/azure-batch-cli-extensions-2.4.1/azure_batch_cli_extensions-2.4.1-py2.py3-none-any.whl
